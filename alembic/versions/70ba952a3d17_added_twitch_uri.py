...
Revision ID: 70ba952a3d17
Revises: acbad3a26c91
Create Date: 2025-03-01 00:19:53.809209
...
revision: str = '70ba952a3d17'
down_revision: Union[str, None] = 'acbad3a26c91'
...
def upgrade() -> None:
    ...
    op.drop_index('twitch_user_uri', table_name='user_tokens')
...
def downgrade() -> None:
    ...
    sa.Column('twitch_user_uri', mysql.VARCHAR(length=255), nullable=True),
    ...
    op.create_index('twitch_user_uri', 'user_tokens', ['twitch_user_uri'], unique=True)
    # ### end Alembic commands ###
